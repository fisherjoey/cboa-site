...
const categoryEmailMap: Record<string, string> = {
  general: 'secretary@cboa.ca',
  scheduling: 'scheduler@cboa.ca',
  billing: 'treasurer@cboa.ca',
  membership: 'memberservices@cboa.ca',
  education: 'education@cboa.ca',
  website: 'webmaster@cboa.ca',
  performance: 'performance@cboa.ca',
  recruiting: 'recruiting@cboa.ca',
  other: 'secretary@cboa.ca',
}
...
export const handler: Handler = async (
  ...
  try {
    ...
    const emailContent = `
      ...
      <p>A new message has been submitted through the CBOA website contact form.</p>
