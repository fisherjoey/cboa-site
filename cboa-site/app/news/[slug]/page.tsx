...
export default async function NewsArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-cboa-blue text-white py-16">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-cboa-blue mb-6">More News</h2>
              ...
              {getAllContent('news')
                ...
                .map((relatedArticle) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-cboa-blue mt-2 mb-2">
