...
const palettes = {
  ...
  zincBlue: {
    name: 'Zinc + CBOA Blue',
    description: 'Zinc neutrals with CBOA navy header, blue-tinted dark mode, and muted category colors that don\'t compete with content.',
    light: {
      pageBg: '#fafafa',
      cardBg: '#ffffff',
      cardBorder: '#e4e4e7',
    ...
    <div style={{ background: t.pageBg, borderRadius: '16px', overflow: 'hidden', border: `1px solid ${t.cardBorder}` }}>
      ...
      <div style={{ background: t.headerBg, padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            <div style={{ color: '#ffffff', fontSize: '13px', fontWeight: 700, letterSpacing: '-0.01em' }}>CBOA Portal</div>
            <div style={{ color: t.navText, fontSize: '10px' }}>Calgary Basketball Officials</div>
          </div>
        </div>
