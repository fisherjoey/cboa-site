...
export default function OfficialsBookingForm() {
  ...
  if (isSubmitted) {
    return (
      <Card className="max-w-2xl mx-auto p-12 text-center">
        ...
        <h2 className="text-3xl font-bold text-cboa-blue mb-4">Request Submitted Successfully!</h2>
        <p className="text-gray-600 mb-6">
          Thank you for your officials request. We'll review your submission and contact you within 24-48 hours.
        </p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-cboa-blue focus:border-cboa-blue"
            />
          </div>
        </div>
      </Card>
        ...
        <div className="mt-4">
          <label className="flex items-start">
            ...
            <span className="text-sm text-gray-700">
              I understand that I will be invoiced for officiating services at the current CBOA rates
      ...
      {/* Event Contact */}
      <Card className="p-6">
        <h3 className="text-xl font-bold text-cboa-blue mb-4">Event Contact (if different from billing)</h3>
        <div className="grid md:grid-cols-2 gap-4">
          <div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <button
            ...
            className={`p-4 border-2 rounded-lg text-center transition-colors ${
              eventType === 'league'
                ? 'border-cboa-blue bg-cboa-blue/5'
