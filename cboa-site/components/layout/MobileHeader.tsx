...
export default function MobileHeader() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <header className="sticky top-0 z-50 bg-cboa-dark text-white shadow-lg">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-300 -mt-1">Calgary Basketball Officials</p>
              </div>
            </Link>
            ...
            <div className="pb-4 -mt-2 animate-slideDown">
              <form className="relative" onSubmit={(e) => {
                ...
                <input
                  ...
                  placeholder="Search..."
                  className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:border-cboa-orange focus:bg-white/20 transition-colors"
                  autoFocus
                />
                <button
                  type="submit"
                ...
                <li key={link.href}>
                  <Link
                    ...
                    className={`flex items-center gap-2 px-4 py-3 border-b-2 transition-colors ${
                      isActive(link.href)
                        ? 'border-cboa-orange bg-white/10 text-cboa-orange'
              ...
              {navLinks.map(link => (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 transition-colors ${
                    isActive(link.href)
                      ? 'bg-cboa-orange/10 text-cboa-orange border-l-4 border-cboa-orange'
