...
export class LocalStorageAdapter implements StorageAdapter {
  ...
  constructor(storageKey: string = 'cboa_files') {
...
export const localResourcesStorage = new LocalStorageAdapter('cboa_resources_files')
export const localNewsletterStorage = new LocalStorageAdapter('cboa_newsletters_files')